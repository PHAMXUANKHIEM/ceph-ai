        ...
        for incident in open_incidents:
            ...
            if incident.ceph_code not in current_codes:
                ...
                if key not in recovered:
                    ...
                    # Session.commit() expires ORM attributes by default and
                    # this alert is deliberately sent after the transaction.
                    # Snapshot the channel values while the Cluster is still
                    # attached instead of carrying it beyond the session.
