...
- Production 05 — Security baseline: **đang triển khai**; production credential/database startup gates, CSRF, login/API rate limit, security regression và trusted proxy boundary đã có; còn cần hoàn tất RBAC/tenant/audit review chung.
