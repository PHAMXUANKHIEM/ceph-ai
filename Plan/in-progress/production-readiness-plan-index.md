...
- Production 05 — Security baseline: **đang triển khai**; production credential/database startup gates, CSRF và multi-replica rate limit đã có; security regression và trusted proxy boundary còn mở.
