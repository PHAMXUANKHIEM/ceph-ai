...
Validation hiện có: targeted regression đạt `137 passed, 12 warnings`; full
...
- **AI:** ADWIN policy/state và bounded replay đã có trong forecast path; drift
  hiện ghi confidence/status/promotion block vào evidence. Online consumer vẫn
  ghi cứng `target="shadow"`; promotion/rollback E2E và nhiều boundary vẫn mở.
