...
def test_admin_delete_all_buckets_is_blocked_without_per_bucket_approval(dashboard_client):
    _login(dashboard_client)
...
def test_delete_all_does_not_start_partial_global_purge(dashboard_client):
    _login(dashboard_client)
