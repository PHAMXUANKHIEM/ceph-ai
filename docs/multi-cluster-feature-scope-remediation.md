...
- [ ] 1.4 Giữ `cluster` query parameter trong redirect sau approve/reject và các form liên quan.
...
- [ ] 2.6 Settings kết nối Ceph/OpenStack.
- [ ] 2.7 Telegram/global maintenance controls nếu chúng chỉ áp dụng cluster mặc định.
...
- [ ] 7.3 Approve/reject giữ cluster context và quay về đúng dashboard cluster.
...
- [ ] 8.3 Cluster bị vô hiệu hóa phải bị loại khỏi session selection và mọi scheduler/action mới.
- [ ] 8.4 Cho phép sửa và test lại thông tin kết nối cluster đã tồn tại.
