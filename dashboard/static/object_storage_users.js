(function () {
  ...
  var auditRows = Array.prototype.slice.call(document.querySelectorAll('[data-s3-audit-row]')); var auditPage = 1; var auditSize = 25; var auditPageSizeLabel = '25 dòng/trang'; var auditSearch = document.querySelector('[data-s3-audit-search]'); var auditAction = document.querySelector('[data-s3-audit-action]'); var auditResult = document.querySelector('[data-s3-audit-result]');
...
(function () {
  ...
  if (status) status.textContent = 'Trang 1/' + Math.max(1, Math.ceil(rows.length / size)) + ' · 25 dòng/trang';
